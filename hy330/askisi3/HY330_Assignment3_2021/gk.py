...
class gk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.carier_freq = carier_freq = 1e3
        ...
        self._carier_freq_range = Range(0, 10e3, 1e3, 1e3, 200)
        ...
        self.analog_random_source_x_0_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 2, 9600))), True)
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 2, 9600))), True)
