...
namespace gr
{
    namespace cs330project
    {
        ...
        private:
            const int d_type;
            std::vector<uint8_t> packet_after_encoding;
            std::vector<uint8_t> packet_after_encoding_in_bytes;
            void vector_of_bits_to_bytes(std::vector<uint8_t> vector_bits,std::vector<uint8_t> &);
