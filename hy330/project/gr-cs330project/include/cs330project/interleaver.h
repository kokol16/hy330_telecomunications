...
#ifndef INCLUDED_CS330PROJECT_INTERLEAVER_H
#define INCLUDED_CS330PROJECT_INTERLEAVER_H
 ...
 *
 */
class CS330PROJECT_API interleaver : virtual public gr::block {
public:
    typedef boost::shared_ptr<interleaver> sptr;

    /*!
     * \brief Return a shared_ptr to a new instance of cs330project::interleaver.
     *
     * To avoid accidental use of raw pointers, cs330project::interleaver's
     * constructor is in a private implementation
     * class. cs330project::interleaver::make is the public interface for
...
#endif /* INCLUDED_CS330PROJECT_INTERLEAVER_H */
