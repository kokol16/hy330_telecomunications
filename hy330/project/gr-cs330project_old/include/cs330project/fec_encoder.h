...
#ifndef INCLUDED_CS330PROJECT_FEC_ENCODER_H
#define INCLUDED_CS330PROJECT_FEC_ENCODER_H
...
/*!
 * \brief Encodes a received message with one of the availabe FEC algorithms
 * The FEC types are:
 *  0: No FEC
 ...
 *
 */
class CS330PROJECT_API fec_encoder : virtual public gr::block {
public:
    typedef boost::shared_ptr<fec_encoder> sptr;
...
#endif /* INCLUDED_CS330PROJECT_FEC_ENCODER_H */
